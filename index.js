...
app.post('/createOrder', async (req, res) => {
    try {
        ...
        if (paymentMethod == "AMEX") {  
            ...
            var fnInvokeEndpoint = "https://gw7unyffbla.eu-frankfurt-1.functions.oci.oraclecloud.com/20181201/functions/ocid1.fnfunc.oc1.eu-frankfurt-1.aaaaaaaaabr5clxflxviahwoerdidwlsy65tzga7xvmjfl4bsk6hi2a4br2q/actions/invoke";
